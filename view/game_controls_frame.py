...
class NewGameInputDialog(ctk.CTkToplevel):
    ...
    def __init__(self, master=None) -> None:
        ...
        self.option_menu = ctk.CTkOptionMenu(
            self, variable=self.selected_option, values=self.option_values
        )
...
class GameControlsFrame(ctk.CTkFrame):
    ...
    This class handles the creation of the game mode selection combo box, the
    new game button, and the game timer display.
    """
    ...
    def create_remaining_flag_label(self) -> None:
        ...
        flag_image = ctk.CTkImage(
            light_image=Image.open(
                "./py_minesweeper/resources/images/bomb.png"
            ),
    ...
    def start_new_game(self) -> None:
        ...
        This method resets the game timer and prepares the game for a new 
        session.
        """
    ...
    def update_game_timer(self) -> None:
        ...
        This method increments the game timer by one second and updates the 
        display.
        """
        self._seconds += 1
    ...
    def reset_game_timer(self) -> None:
        ...
        This method stops the current timer, resets the timer to zero, and 
        starts it again.
        """
        if self._after_id:
